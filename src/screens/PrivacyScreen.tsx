...
import { View, Text, TouchableOpacity, ScrollView, StatusBar, Alert, Modal, TextInput, ActivityIndicator, KeyboardAvoidingView, Platform } from 'react-native';
    ...
    return (
        <SafeAreaView className="flex-1 bg-slate-50" edges={['top']}>
            ...
            <View className="flex-row items-center px-6 py-4 border-b border-slate-100 bg-white">
                ...
                <Text className="text-xl font-bold text-slate-900 ml-2">Privacy & Security</Text>
            </View>

            <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
                <View className="bg-white p-6 rounded-3xl border border-slate-200 mb-6">
                    <View className="flex-row items-center mb-6">
                        ...
                        <View className="ml-4">
                            <Text className="text-slate-900 font-bold text-lg">Your data is secure</Text>
                            <Text className="text-slate-500 text-sm">We use end-to-end encryption</Text>
                        </View>
                    </View>

                    <Text className="text-slate-900 font-bold mb-2">Privacy Policy</Text>
                ...
                <TouchableOpacity
                    ...
                    className="bg-white p-5 rounded-2xl border border-slate-200 flex-row items-center mb-4"
                >
                    <MaterialCommunityIcons name="lock-reset" size={22} color="#64748B" />
                    <Text className="flex-1 ml-4 text-slate-800 font-bold">Change Password</Text>
                    <MaterialCommunityIcons name="chevron-right" size={20} color="#CBD5E1" />
                </TouchableOpacity>

                <TouchableOpacity
                    onPress={handleDeleteAccount}
                    className="bg-white p-5 rounded-2xl border border-slate-200 flex-row items-center mb-10"
                >
            ...
            >
                <View className="flex-1 bg-black/50">
                    ...
                    >
                        <View className="bg-white rounded-t-[40px] p-8 pb-12 max-h-[90%]">
                            <View className="w-12 h-1.5 bg-slate-200 rounded-full self-center mb-8" />

                            <Text className="text-2xl font-black text-slate-900 mb-2">Change Password</Text>
                            <Text className="text-slate-500 font-medium mb-8">Keep your account secure with a strong password.</Text>
                            ...
                            >
                                <Text className="text-slate-900 font-bold text-xs uppercase tracking-widest mb-2 ml-1">Current Password</Text>
                                <View className="bg-slate-50 border border-slate-100 rounded-2xl px-4 h-14 flex-row items-center mb-4">
                                ...
                                <Text className="text-slate-900 font-bold text-xs uppercase tracking-widest mb-2 ml-1">New Password</Text>
                                <View className="bg-slate-50 border border-slate-100 rounded-2xl px-4 h-14 flex-row items-center mb-4">
                                    <MaterialCommunityIcons name="lock-plus-outline" size={20} color="#94A3B8" />
                                    <TextInput
                                        className="flex-1 ml-3 text-slate-900 font-medium"
                                ...
                                <Text className="text-slate-900 font-bold text-xs uppercase tracking-widest mb-2 ml-1">Confirm New Password</Text>
                                <View className="bg-slate-50 border border-slate-100 rounded-2xl px-4 h-14 flex-row items-center mb-8">
                                    <MaterialCommunityIcons name="lock-check-outline" size={20} color="#94A3B8" />
                                    <TextInput
                                        className="flex-1 ml-3 text-slate-900 font-medium"
